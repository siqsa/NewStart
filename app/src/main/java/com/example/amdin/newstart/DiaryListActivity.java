...
public class DiaryListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final GestureDetector gestureDetector = new GestureDetector(DiaryListActivity.this,new GestureDetector.SimpleOnGestureListener()
        {
            @Override
        ...
        recyclerView.addOnItemTouchListener(new RecyclerView.OnItemTouchListener() {
            ...
            public boolean onInterceptTouchEvent(RecyclerView rv, MotionEvent e) {
                ...
                int touchPosition=rv.getChildLayoutPosition(child);
                Toast.makeText(getApplicationContext(),touchPosition+"번째 레이아웃",Toast.LENGTH_SHORT).show();}
                return false;
            }
